...
See the **Quickstart** section below to get started and the `/examples` folder for more in-depth jupyter notebook walkthroughs using several popular open-source data sets. For comprehensive documentation on the main model class and the evaluation methods see the [Online Documentation](https://rankfm.readthedocs.io/en/latest/).
